...
bool LightShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	//result = InitializeShader(device, hwnd, L"../Engine/light.vs", L"../Engine/celpixelshader.ps");
	if(!result)
	{
		return false;
	}
							  ...
							  D3DXMATRIX projectionMatrix , D3DXVECTOR3 lightDirection, D3DXVECTOR4 diffuseColor, D3DXVECTOR4 ambientColor, float deltavalue, ID3D11ShaderResourceView* texture)
{
	...
	result = SetShaderParameters(deviceContext, worldMatrix, viewMatrix, projectionMatrix, lightDirection, diffuseColor, ambientColor, deltavalue, texture);
	if(!result)
	{
		return false;
	}
...
bool LightShaderClass::SetShaderParameters(ID3D11DeviceContext* deviceContext, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, 
										   ...
										   D3DXVECTOR4 diffuseColor,D3DXVECTOR4 ambientColor, float deltavalue,ID3D11ShaderResourceView* texture )
{
	HRESULT result;
